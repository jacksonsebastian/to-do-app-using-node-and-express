...
let dbString = "mongodb+srv://Jackson:Jackson@cluster0.r0rsnrj.mongodb.net/myApp?retryWrites=true&w=majority"
let dbName = 'myApp'
...
function passProtected(req, res, next){
  ...
  if(req.headers.authorization == 'Basic amFja3NvbjpqYWNrQCMxMjM='){
    next()
  }else {
    res.status(401).send("Please give valid credential")
  }
}
